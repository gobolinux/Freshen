...
installed or upgraded before doing so, using first
`Freshen [<options>] [<list>]` to generate and display the list, and
then `Freshen -i` to install the programs in that list.
