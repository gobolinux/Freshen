...
class Freshen(object):
	...
	def _make_update(self,upd,examinedProgram):
		program,version,revision,type,url,activeflags = upd
		...
		if 'recipe' == type:
			...
			disabledFlags = (potentialFlags(url)
								- enabledFlags)
		return (program,version,revision,type,url,examinedProgram,
	...
	def _program_updates_each(self, upd, examinedProgram):
		...
		if type != 'installed' and type is not None:
			...
			insVers = insVer and self.installedPrograms()[program] or ()
