...
version = {'major': 3, 'minor': 0, 'revision': 0, 'prerelease': ''}
...
class Freshen(object):
	...
	def updates(self, onExamine=None, last=False):
		...
		try:
			...
			for examinedProgram in toExamine:
				...
				for program,version,revision,type,url in (upd for upd in
					                                      orderedMatches if
					                                      upd[0] not in
					                                      considered):
